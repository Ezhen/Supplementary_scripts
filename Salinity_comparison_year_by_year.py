...
temp_avg=np.zeros((10,364))
for m in range(0,10):
	ncdata = Dataset('/media/sf_Swap-between-windows-linux/New_Grid/RESULTS/ocean_avg_%s.nc' %(m+1), 'r', format='NETCDF3')
	t = ncdata.variables['ocean_time'][:]
	for p in range(len(t)):
		a=0;b=0
		temp=ncdata.variables['salt'][p,:,:,:]
